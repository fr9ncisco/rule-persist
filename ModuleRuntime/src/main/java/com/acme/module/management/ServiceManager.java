...
/**
 * This class is a JMX Bean singleton that manages services, for registering themselves with it
 * and upon request, updates these services with latest rule archives exactly dedicated to these services.
 */
public class ServiceManager implements ServiceManagerMXBean{
    ...
    /**
     * This methods returns the latest {@link ReleaseId} for a specific module is it exists in the latest {@link PersistedModule} list.
     *
     * @param module
     * @param latestModules
     * @return the latest ReleaseId for module or null if there is not new release id
     */
    ...
    /**
     * This method helps to remove duplicates from a persisted modules list
     * @param pModules
     * @return a List of PersistedModule
     */
    ...
    /**
     * This method allows for a service to register itself to the JMX bean
     * @param service
     */
    ...
    /**
     *  This method helps to get the names of registered rule services on this JMX bean
